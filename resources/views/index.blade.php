...
<head>
    ...
    <title>Hotel KEEPLER</title>
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Sharp" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('index1/css/styles.css')}}">
...
<body>
    <header class="header">
      <nav>
        ...
        <a href="{{ route('login') }}" class="login"><button>Iniciar Sesión</button></a>
      </nav>
      <div class="section__container header__container" id="home">
        <p>Simple - Unico - Amigable</p>
        <h1>El mundo A Un <br>
        Click De distancia<br />Ahora Nuestro <span>Hotel</span>.</h1>
      </div>
    </header>
      ...
      <div class="section__container footer__container">
        ...
        <div class="footer__col">
          ...
          <div class="footer__socials">
            ...
            <a href="#"><img src="{{ asset('assets/X.png') }}" alt="X" /></a>
          </div>
        </div>
      </div>
      <div class="footer__bar">
        Copyright © 2024 KEEPLER SYSTEMS. All rights reserved.
      </div>
    </footer>
